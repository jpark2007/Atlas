// =====================================================================
// Atlas waitlist — Supabase Edge Function  (STAGING COPY — NOT DEPLOYED)
//
// This file lives in landing/supabase-staging/ only. It is NOT wired into
// the app's real supabase/ tree. To ship it, move this folder to
// supabase/functions/waitlist/ and deploy (see landing/README.md).
//
